  ...
  const placesByCity: Record<string, Place[]> = {
    ...
    "Vancouver, BC": [
      ...
      },
      {
        ...
        imageUrl: "",
        description:
          "Popular sandy beach with sunset views and the iconic inukshuk statue.",
      },
      {
        id: "van10",
        ...
        imageUrl: "",
        description:
          "Historic neighborhood with cobblestone streets, galleries, and the famous steam-powered clock.",
      },
      {
        id: "van11",
        ...
        imageUrl: "",
        description:
          "Elevated Indian cuisine by celebrity chef Vikram Vij. No reservations, worth the wait.",
      },
      {
        id: "van12",
        name: "Deep Cove",
        ...
        imageUrl: "",
        description:
          "Picturesque village with kayaking, the Quarry Rock hike, and famous honey doughnuts.",
      },
      {
        id: "van13",
        name: "The Keefer Bar",
        ...
        imageUrl: "",
        description:
          "Apothecary-themed cocktail bar in Chinatown with Asian-inspired drinks.",
      },
      {
        id: "van14",
        name: "Japadog",
        ...
        imageUrl: "",
        description:
          "Japanese-style hot dogs with unique toppings. A Vancouver street food icon.",
      },
      {
        id: "van15",
        ...
        imageUrl: "",
        description:
          "Free suspension bridge over a stunning canyon. Less crowded alternative to Capilano.",
      },
      {
        id: "van16",
        name: "Spa Utopia",
        ...
        imageUrl: "",
        description:
          "Waterfront spa at Pan Pacific hotel with steam room, eucalyptus inhalation, and harbour views.",
      },
    ],
    "Oakville, ON": [
      {
      ...
      },
      {
        ...
        category: "OUTDOORS",
        address: "1306 Lakeshore Rd E, Oakville, ON",
        latitude: 43.4410,
        longitude: -79.6493,
        rating: 4.5,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Lakefront estate gardens with walking paths, old growth trees, and art gallery.",
      },
      {
        id: "oak10",
        name: "Bru Restaurant",
        category: "FOOD",
        address: "162 Lakeshore Rd E, Oakville, ON",
        latitude: 43.4473,
        longitude: -79.6650,
        rating: 4.6,
        amazonRating: 4.7,
        ...
        imageUrl: "",
        description:
          "Modern Canadian cuisine with craft cocktails in a stylish downtown setting.",
      },
      {
        id: "oak11",
        name: "Coronation Park",
        category: "OUTDOORS",
        address: "145 Lakeshore Rd W, Oakville, ON",
        latitude: 43.4406,
        longitude: -79.6750,
        rating: 4.4,
        amazonRating: 4.5,
        ...
        imageUrl: "",
        description:
          "Waterfront park with splash pad, trails, and picnic areas along Lake Ontario.",
      },
      {
        id: "oak12",
        name: "Noble Bistro",
        category: "FOOD",
        address: "130 Navy St, Oakville, ON",
        latitude: 43.4451,
        longitude: -79.6683,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Farm-to-fork bistro with seasonal Ontario ingredients and excellent brunch.",
      },
      {
        id: "oak13",
        name: "Oakville Museum",
        category: "CULTURE",
        address: "8 Navy St, Oakville, ON",
        latitude: 43.4440,
        longitude: -79.6687,
        rating: 4.2,
        amazonRating: 4.3,
        ...
        imageUrl: "",
        description:
          "Local history museum in heritage buildings along the lakefront.",
      },
      {
        id: "oak14",
        name: "The Tap House Grill",
        category: "NIGHTLIFE",
        address: "211 Lakeshore Rd E, Oakville, ON",
        latitude: 43.4471,
        longitude: -79.6629,
        rating: 4.3,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Sports bar with large patio, craft beers on tap, and late-night menu.",
      },
      {
        id: "oak15",
        name: "Sixteen Mile Creek Trail",
        category: "OUTDOORS",
        address: "Sixteen Mile Creek, Oakville, ON",
        latitude: 43.4350,
        longitude: -79.6880,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Scenic trail system through wooded ravine. Great for trail running and cycling.",
      },
      {
        id: "oak16",
        name: "Elora Day Trip",
        ...
        imageUrl: "",
        description:
          "Charming 19th-century village with a dramatic gorge, artisan shops, and cafes. 45-min drive.",
      },
    ],
    "Stoney Creek, ON": [
      {
      ...
      },
      {
        ...
        category: "OUTDOORS",
        address: "Fallsview Rd, Hamilton, ON",
        latitude: 43.2702,
        longitude: -79.9804,
        rating: 4.6,
        amazonRating: 4.7,
        ...
        imageUrl: "",
        description:
          "Stunning 22-metre curtain waterfall. One of Hamilton's most photographed spots.",
      },
      {
        id: "sc10",
        name: "Pier 8 Hamilton",
        category: "OUTDOORS",
        ...
        imageUrl: "",
        description:
          "Revitalized waterfront park with splash pad, urban beach, and harbour views.",
      },
      {
        id: "sc11",
        name: "Born & Raised",
        category: "FOOD",
        address: "1 James St N, Hamilton, ON",
        latitude: 43.2559,
        longitude: -79.8686,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Elevated comfort food with weekend brunch in Hamilton's arts district.",
      },
      {
        id: "sc12",
        ...
        imageUrl: "",
        description:
          "10,000+ works of Canadian and international art with rotating exhibitions.",
      },
      {
        id: "sc13",
        name: "Fairweather Brewing",
        category: "NIGHTLIFE",
        address: "5 Ofield Rd, Hamilton, ON",
        latitude: 43.2437,
        longitude: -79.8523,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Craft brewery with a chill taproom, patio, and rotating food pop-ups.",
      },
      {
        id: "sc14",
        name: "The Mule",
        ...
        imageUrl: "",
        description:
          "Mexican-inspired cantina with excellent tacos and creative margaritas.",
      },
      {
        id: "sc15",
        name: "Tiffany Falls",
        category: "OUTDOORS",
        address: "Tiffany Falls Conservation Area, Hamilton, ON",
        latitude: 43.2385,
        longitude: -79.9389,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Gorgeous ribbon waterfall with short accessible trail. Quiet and serene.",
      },
      {
        id: "sc16",
        name: "Lakelands Golf & Country",
        category: "WELLNESS",
        address: "171 Grey Rd, Stoney Creek, ON",
        latitude: 43.2050,
        longitude: -79.7350,
        rating: 4.3,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Public golf course with scenic views of the Escarpment. Good for a relaxed round.",
      },
    ],
    "Cambridge, ON": [
      {
      ...
      },
      {
        ...
        imageUrl: "",
        description:
          "Reservoir park with swimming beach, hiking trails, and fishing.",
      },
      {
        id: "cam10",
        name: "Elora Gorge",
        ...
        imageUrl: "",
        description:
          "Dramatic limestone gorge with tubing, camping, and cliff views. Summer must-do.",
      },
      {
        id: "cam11",
        name: "Sopra Upper Kitchen",
        category: "FOOD",
        address: "35 Queen St E, Cambridge, ON",
        latitude: 43.3598,
        longitude: -80.3107,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Italian restaurant with handmade pasta and wood-fired dishes in historic Galt.",
      },
      {
        id: "cam12",
        name: "McDougall Cottage",
        category: "CULTURE",
        address: "89 Grand Ave S, Cambridge, ON",
        latitude: 43.3547,
        longitude: -80.3155,
        rating: 4.3,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Scottish weaver's cottage turned art gallery. Free entry with rotating local artists.",
      },
      {
        id: "cam13",
        name: "Rhythm & Brews",
        category: "NIGHTLIFE",
        address: "21 Ainslie St N, Cambridge, ON",
        latitude: 43.3600,
        longitude: -80.3118,
        rating: 4.3,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Live music pub with local bands, craft beer, and a welcoming vibe.",
      },
      {
        id: "cam14",
        name: "Blackshop Restaurant",
        category: "FOOD",
        ...
        imageUrl: "",
        description:
          "Award-winning farm-to-table dining in a historic Cambridge building by the river.",
      },
      {
        id: "cam15",
        name: "Cambridge Centre for the Arts",
        category: "CULTURE",
        address: "60 Dickson St, Cambridge, ON",
        latitude: 43.3591,
        longitude: -80.3125,
        rating: 4.2,
        amazonRating: 4.3,
        ...
        imageUrl: "",
        description:
          "Community arts centre with theatre productions, galleries, and workshops.",
      },
      {
        id: "cam16",
        name: "Dumfries Conservation Area",
        category: "OUTDOORS",
        address: "2558 Dumfries Rd, Cambridge, ON",
        latitude: 43.3362,
        longitude: -80.3810,
        rating: 4.4,
        amazonRating: 4.5,
        ...
        imageUrl: "",
        description:
          "Nature reserve with 8km of trails through Carolinian forest. Good for birding.",
      },
    ],
    "Kitchener, ON": [
      {
      ...
      },
      {
        ...
        name: "Waterloo Park",
        category: "OUTDOORS",
        address: "100 Father David Bauer Dr, Waterloo, ON",
        latitude: 43.4648,
        longitude: -80.5310,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Large urban park with lake, zoo, trails, and Laurel Creek running through it.",
      },
      {
        id: "kit10",
        name: "Arabella Park",
        category: "FOOD",
        address: "33 Erb St W, Waterloo, ON",
        latitude: 43.4636,
        longitude: -80.5212,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Upscale brunch and dinner spot with craft cocktails in Uptown Waterloo.",
      },
      {
        id: "kit11",
        name: "KW Art Gallery",
        category: "CULTURE",
        address: "101 Queen St N, Kitchener, ON",
        latitude: 43.4535,
        longitude: -80.4912,
        rating: 4.3,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Contemporary art gallery with rotating exhibitions and community programs. Free.",
      },
      {
        id: "kit12",
        name: "TWB Brewing Co.",
        category: "NIGHTLIFE",
        address: "300 Mill St, Kitchener, ON",
        latitude: 43.4473,
        longitude: -80.4828,
        rating: 4.4,
        amazonRating: 4.5,
        ...
        imageUrl: "",
        description:
          "Together We're Bitter - craft brewery with creative brews and a lively taproom.",
      },
      {
        id: "kit13",
        name: "Homer Watson Park",
        category: "OUTDOORS",
        address: "Homer Watson Blvd, Kitchener, ON",
        latitude: 43.4097,
        longitude: -80.4560,
        rating: 4.5,
        amazonRating: 4.6,
        ...
        imageUrl: "",
        description:
          "Scenic park along the Grand River with trails, swimming hole, and old-growth forest.",
      },
      {
        id: "kit14",
        name: "Beertown Public House",
        category: "NIGHTLIFE",
        address: "20 King St S, Kitchener, ON",
        latitude: 43.4508,
        longitude: -80.4925,
        rating: 4.3,
        amazonRating: 4.4,
        ...
        imageUrl: "",
        description:
          "Upscale pub with 150+ beers on tap, great burgers, and a rooftop patio.",
      },
      {
        id: "kit15",
        name: "Bhima's Warung",
        category: "FOOD",
        address: "47 King St N, Waterloo, ON",
        latitude: 43.4650,
        longitude: -80.5218,
        rating: 4.6,
        amazonRating: 4.7,
        ...
        imageUrl: "",
        description:
          "Indonesian-inspired restaurant with bold flavours. The rendang and roti are outstanding.",
      },
      {
        id: "kit16",
        name: "YogaFit Studio",
        category: "WELLNESS",
        address: "62 Queen St S, Kitchener, ON",
        latitude: 43.4492,
        longitude: -80.4915,
        rating: 4.4,
        amazonRating: 4.5,
        ...
        imageUrl: "",
        description:
          "Drop-in yoga classes in downtown Kitchener. Hot yoga, flow, and restorative options.",
      },
    ],
  };
